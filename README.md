...
Branch name|The name the project has in Sonar is usually the job name post-pended with a branch name e.g. 'JobName BranchName'. Set the branch name to find the
correct job. Case sensitive.|'bugfixBranch'
